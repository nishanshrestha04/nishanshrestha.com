...
const SEO = ({ title, description, keywords, image, url }) => {
  const defaultTitle =
    'Nishan Shrestha | AI/ML Enthusiast & Full Stack Web Developer Portfolio';
  const siteTitle = 'Nishan Shrestha'; // For appending to page titles
  const siteDescription =
    'Nishan Shrestha - AI/ML Enthusiast and Full Stack Web Developer from Nepal. Explore my portfolio of projects in React, Machine Learning, and modern web development.';
  const siteKeywords =
    'Nishan Shrestha, Nishan Shrestha portfolio, Nishan Shrestha developer, Nishan Shrestha Nepal, Web Developer Nepal, AI ML Developer, React Developer, Machine Learning, Full Stack Developer, nishanshrestha04';
